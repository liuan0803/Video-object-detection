...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="/usr/idip/idip/liuan/project/VOD-project/MEGA/mega.pytorch/configs/vid_mega_1gpu.yaml",
        metavar="FILE",
    ...
    BASE_CONFIG = "/usr/idip/idip/liuan/project/VOD-project/MEGA/mega.pytorch/configs/BASE_RCNN_{}gpu.yaml".format(num_gpus)
